...
class AppTheme {
  ...
  static ThemeData dark() => _build(
        ...
        scheme: const ColorScheme(
          ...
          surfaceContainerHighest: Color(0xFF1E2B24),
          outline: Color(0xFF4A6055),
        ),
  ...
  static ThemeData nightTint() => _build(
        ...
        scheme: const ColorScheme(
          ...
          surfaceContainerHighest: Color(0xFF2A1A10),
          outline: Color(0xFF6A4030),
        ),
